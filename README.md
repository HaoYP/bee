...
[![Build Status](https://drone.io/github.com/hongshengjie/bee/status.png)](https://drone.io/github.com/hongshengjie/bee/latest)
...
```bash
go get github.com/hongshengjie/bee
```
...
```bash
go get -u github.com/hongshengjie/bee
```
